...
c***********************************************************************
     ...
     &  gcw0,gcw1,block_id,domain_id,gamma,
     &  uval)
c***********************************************************************
      implicit none
c***********************************************************************
...
c input arrays:
      ...
      integer gcw0,gcw1,block_id,domain_id
      REAL
     &     gamma
...
c
      ...
      else if(block_id.eq.2.and.domain_id==0) then
          rho  = 0.5197d0
          vel0 = -0.6259d0
          vel1 = 0.1d0
          eng  = 0.4d0
      else if(block_id.eq.3.and.domain_id==0) then
          rho  = 1.0d0
          vel0 = 0.1d0
          vel1 = 0.1d0
          eng  = 1.0d0
      else
          stop "wrong block_id or domain_id : "
      endif
c
      do j=ifirst1, ilast1
      do i=ifirst0, ilast0
