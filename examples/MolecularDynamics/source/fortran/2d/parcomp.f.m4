...
c
      implicit none
include(FORTDIR/../2d/model_parameter.i)dnl
c
     ...
     >   (CELL2dVECG(ifirst,ilast,gcw), INDEX_DEPTH)
c
...
C         
       ...
       double precision xdx(3), ddx, ddy
...
c
      ...
      REAL  
     >  load_weight(CELL2dVECG(ifirst,ilast,lgcw),1)  
C
      integer  
     >  index_particles(CELL2dVECG(ifirst,ilast,gcw),INDEX_DEPTH)  
...
c
      ...
      REAL  
     >  particle_density(CELL2dVECG(ifirst,ilast,dgcw),1)  
C
      integer  
     >  index_particles(CELL2dVECG(ifirst,ilast,pgcw)
     >   ,INDEX_DEPTH)  
