...
#ifndef included_FDMBSingDemo
#define included_FDMBSingDemo
...
/**
 * @brief 类 FDMBSingDemo 在单个网格片, 提供数值计算子程序, 
 * 基于移动网格方法求解Euler方程组.
 * 
...
public:
   ...
   FDMBSingDemo(const string& object_name,
...
private:
   ...
   // 变形网格辅助输入工具.
   tbox::Pointer< appu::DeformingGridConstructionUtilities<NDIM,double> > d_grid_tool1;
   tbox::Pointer< appu::DeformingGridInputUtilities2 > d_grid_tool2;
