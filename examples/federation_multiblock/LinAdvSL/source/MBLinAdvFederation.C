 ...
 *
 *************************************************************************/
MBLinAdvFederation::MBLinAdvFederation(const string& object_name,
 ...
 *
 ************************************************************************/
MBLinAdvFederation::~MBLinAdvFederation()
{
 ...
 *
 ************************************************************************/
void MBLinAdvFederation::registerModelVariables()
{
   // 变量数据库.
   ...
   // 邦员的索引号.
   d_federal_left   = d_grid_geometry->getFederalNumber("MBLinAdv_LEFT");
   d_federal_middle = d_grid_geometry->getFederalNumber("MBLinAdv_MIDDLE");
   d_federal_right  = d_grid_geometry->getFederalNumber("MBLinAdv_RIGHT");
 ...
 ************************************************************************/
void MBLinAdvFederation::initializeComponent(algs::IntegratorComponent<NDIM>* intc) const
{
#ifdef DEBUG_CHECK_ASSERTIONS
   assert(intc!=NULL);
#endif
