...
#ifndef included_MBLinAdvLevelIntegrator
#define included_MBLinAdvLevelIntegrator
...
public:
    ...
    */     
   MBLinAdvLevelIntegrator(const string& object_name, MBLinAdv* patch_strategy);

   /**
    * @brief 析构函数.
    */
   virtual ~MBLinAdvLevelIntegrator();
