 ...
 *
 *************************************************************************/
MBLinAdvLevelIntegrator::MBLinAdvLevelIntegrator(
        const string& object_name,
        MBLinAdv* patch_strategy )
{
#ifdef DEBUG_CHECK_ASSERTIONS
 ...
 *
 *************************************************************************/
void MBLinAdvLevelIntegrator::initializeLevelIntegrator(
 ...
 *
 ************************************************************************/
void MBLinAdvLevelIntegrator::initializeLevelData(
 ...
 *
 ************************************************************************/
double MBLinAdvLevelIntegrator::getLevelDt(
 ...
 *
 ************************************************************************/
int MBLinAdvLevelIntegrator::advanceLevel(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
 ...
 *
 ************************************************************************/
void MBLinAdvLevelIntegrator::acceptTimeDependentSolution(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
 ...
 * 为邦员之间的数据传递调度内存空间.
 ************************************************************************/
void MBLinAdvLevelIntegrator::allocateFederalXferData(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
                const double time)
{
#ifdef DEBUG_CHECK_ASSERTIONS
 ...
 * 为邦员之间的数据传递调度内存空间.
 ************************************************************************/
void MBLinAdvLevelIntegrator::deallocateFederalXferData(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level)
{
#ifdef DEBUG_CHECK_ASSERTIONS
     assert(!level.isNull());
