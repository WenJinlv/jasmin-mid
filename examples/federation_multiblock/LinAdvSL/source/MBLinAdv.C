...
#include "CellData.h"
#include "SideData.h"
#include "FederalBlockUniRectangularPatchGeometry.h"
 ...
 *
 *************************************************************************/
MBLinAdv::MBLinAdv(const string& object_name,
      ...
      const string& intc_name)
{
   ...
   if (initial_time) {
      ...
      const tbox::Pointer<geom::FederalBlockUniRectangularPatchGeometry<NDIM> > 
