...
include(FORTDIR/m4fluxcorner.i)dnl
      ...
      subroutine onethirdstate(dt,xlo,dx,omega,idir,
...
c
      REAL xlo(0:NDIM-1),dx(0:NDIM-1),omega(0:NDIM-1)
...
c***********************************************************************
c***********************************************************************
      subroutine fluxthird(dt,xlo,dx,omega,idir,
     &  ifirst0,ilast0,ifirst1,ilast1,ifirst2,ilast2,
     &  uval,
     &  st3,
     &  flux0,flux1,flux2)
...
c***********************************************************************
c***********************************************************************
      subroutine fluxcorrecjt(dt,xlo,dx,omega,idir,
     &  ifirst0,ilast0,ifirst1,ilast1,ifirst2,ilast2,
     &  uval,
     &  flux0,flux1,flux2,
