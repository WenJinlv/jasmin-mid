...
c
      REAL 
     &     xlo(0:NDIM-1),dx(0:NDIM-1),omega(0:NDIM-1)
...
c***********************************************************************
c***********************************************************************
      subroutine fluxcalculation(dt,xcell0,xcell1,visco,dx,xlo,omega,
     &  ifirst0,ilast0,ifirst1,ilast1,ifirst2,ilast2,
     &  uval,
     &  flux0,flux1,flux2,
...
c input arrays:
      ...
      REAL dt
      REAL 
     &     dx(0:NDIM-1),xlo(0:NDIM-1),omega(0:NDIM-1)
c variables in 2d cell indexed         
      REAL
     &     uval(CELL3d(ifirst,ilast,CELLG))
...
c
ccccriemann_solve(1,0,2,`ic2,ic0',xcell0,xcell1)dnl

riemann_solve(1,2,0,`ic2,ic0',xcell1,xcell0)dnl
