...
#ifndef included_RotAdvLevelIntegrator
#define included_RotAdvLevelIntegrator
...
public:
    ...
    * @brief 构造函数.
    */     
   RotAdvLevelIntegrator(const string& object_name,
