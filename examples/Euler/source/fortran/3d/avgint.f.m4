c
c  文件名:        avgint.m4
c  软件包:     JASMIN applications
c  版权  :	(c) 2004-2010 北京应用物理与计算数学研究所
c  版本号:    $Revision: 170 $
c  修改  :    $Date: 2007-06-27 08:44:22 +0800 (涓, 27  6 2007) $
c  描述  : F77 routines for conservative interlevel transfer of velocity 
