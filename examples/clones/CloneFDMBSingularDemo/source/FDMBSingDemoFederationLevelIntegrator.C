 //
// 文件名:  FDMBSingDemoFederationLevelIntegrator.C
// 软件包:  JASMIN applications
// 版权  :  (c) 2004-2010 北京应用物理与计算数学研究所
// 版本号:  $Revision: 250 $
// 修改  :  $Date: 2007-05-24 10:56:58$
// 描述  :  联邦多块变形结构网格的网格层时间积分算法的实现.
//
 ...
 *
 *************************************************************************/
FDMBSingDemoFederationLevelIntegrator::FDMBSingDemoFederationLevelIntegrator(
 ...
 * 该函数创建了1个内存构件，1个联邦构件.
 *************************************************************************/
void FDMBSingDemoFederationLevelIntegrator::initializeLevelIntegrator(
 ...
 * 初始化指定网格层的数据片.
 ************************************************************************/
void FDMBSingDemoFederationLevelIntegrator::initializeLevelData(
 ...
 * 计算时间步长.
 ************************************************************************/
double FDMBSingDemoFederationLevelIntegrator::getLevelDt(
 ...
 * 向前积分一个时间步.
 ************************************************************************/
int FDMBSingDemoFederationLevelIntegrator::advanceLevel(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
                ...
                double&      actual_dt)
{
     ...
     for(int fd=0; fd<d_nfederals; fd++) {
         d_level_integrator[fd]->allocateFederalXferData(
                 fd_level->getMultiblockPatchLevelForFederal(fd),current_time); 
     }
 ...
 *
 ************************************************************************/
void FDMBSingDemoFederationLevelIntegrator::acceptTimeDependentSolution(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
