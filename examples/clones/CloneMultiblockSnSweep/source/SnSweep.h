...
private:
   ...
   void computeSourceItemOnPatch(hier::Patch<NDIM>& patch,const double dt);
   void updateVolumeFluxOnPatch(hier::Patch<NDIM>& patch);


   string d_object_name;         /*!< 对象名 */
   tbox::Pointer<geom::MultiblockUniRectangularGridGeometry<NDIM> > d_grid_geometry; /*!< 网格几何 */
   ...
   int d_mg_end;
   int d_mg_end2;
   bool d_need_clone_param;
   int d_mg_depth;
   tbox::Array<int> d_loc2glob;
#ifdef TESTING   
   double d_yd0, d_yd1;
