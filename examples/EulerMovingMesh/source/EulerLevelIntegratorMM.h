...
#ifndef included_EulerLevelIntegratorMM
#define included_EulerLevelIntegratorMM
...
public:
    ...
    * @brief 构造函数.
    */     
   EulerLevelIntegratorMM(const string& object_name,
                   tbox::Pointer<tbox::Database> input_db,
		   EulerMM* patch_strategy,
    ...
    * @brief 析构函数.
    */
   virtual ~EulerLevelIntegratorMM();
...
private:
   ...
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_grad_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_pde_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_wc0_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_wci_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_coords_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_movegrad_intc;
   tbox::Pointer< algs::NumericalIntegratorComponent<NDIM> >   d_movesolu_intc;
   ...
   tbox::Pointer< algs::CopyIntegratorComponent<NDIM> > d_cycle_copy_intc;
